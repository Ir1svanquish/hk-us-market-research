...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build V2 macro scenario calibration")
    parser.add_argument("--as-of", type=date.fromisoformat, default=date.today())
    parser.add_argument("--lookback-days", type=int, default=180)
    parser.add_argument("--cache-dir", type=Path, default=V2_ROOT / "cache" / "nasdaq_macro")
    parser.add_argument(
        "--output",
        type=Path,
