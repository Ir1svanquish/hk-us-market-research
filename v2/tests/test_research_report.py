...
from v2.dedup_report import DedupReport
from v2.research_report import load_stocks, parse_market_research, render_html
...
"""
    ...
    def test_structured_stock_keeps_relative_volume_social_and_v2(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(stocks[0].v2["final_action"], "可执行计划")
            ...
            self.assertIn("V2 质量、事件与执行复核", document)
