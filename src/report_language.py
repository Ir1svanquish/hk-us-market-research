...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "not_investment_advice": "内容由自动化流程生成，仅供参考，不构成投资建议",
    ...
    "en": {
        ...
        "not_investment_advice": "Generated by an automated research workflow for reference only. Not investment advice.",
...
def infer_decision_type_from_advice(value: Any, default: str = "hold") -> str:
    ...
    if canonical in {"strong_buy", "buy"}:
        return "buy"
    if canonical in {"strong_sell", "sell"}:
        return "sell"
    if canonical == "reduce":
        return "hold"
