...
_MARKET_GUIDELINES = {
    "cn": {
        ...
        "en": (
            ...
            "- Use CNY for all quote prices, trading levels, turnover, and market values."
        ),
    },
    "hk": {
        "zh": (
            ...
            "- 所有股价和交易点位使用港元，成交额使用港元/万港元/亿港元；禁止写成人民币元。"
        ),
        "en": (
            ...
            "- Use HKD for all quote prices, trading levels, turnover, and market values."
        ),
    },
    "us": {
        "zh": (
            ...
            "- 所有股价和交易点位使用美元，成交额使用美元/万美元/亿美元；禁止写成人民币元。"
        ),
        "en": (
            ...
            "- Use USD for all quote prices, trading levels, turnover, and market values."
        ),
    },
}

_MARKET_CURRENCY_UNITS = {
    "cn": {"zh": "元", "en": "CNY"},
    "hk": {"zh": "港元", "en": "HKD"},
    "us": {"zh": "美元", "en": "USD"},
}
...
def get_market_currency_unit(stock_code: Optional[str], lang: str = "zh") -> str:
    """Return the quote-currency label for a stock code."""
    market = detect_market(stock_code)
    lang_key = "en" if lang == "en" else "zh"
    return _MARKET_CURRENCY_UNITS.get(market, _MARKET_CURRENCY_UNITS["cn"])[lang_key]
