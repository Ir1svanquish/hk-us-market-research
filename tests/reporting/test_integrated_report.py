...
from reporting.integrated_report import (
    CSS,
    _SourceRegistry,
    _adaptive_chunks,
    _ai_crowding_panel,
...
class IntegratedReportTests(unittest.TestCase):
        ...
        summary = {
            "markets": {
                "us": {
                    ...
                    "reporting_rolling_20": {"periods": 2, "triggered": 1, "trigger_eligible": 2},
                    ...
                    "latest_reporting_run": {"pool_size": 20, "official_coverage": 100, "relative_strength_coverage": 100, "volume_coverage": 100, "overlap_ratio": 60},
                }
            }
        }
    ...
    def test_public_scenarios_ignore_historical_ma_instructions(self):
        item = {
            "execution": {
                "status": "等待触发",
                "standard_trade_card": {
