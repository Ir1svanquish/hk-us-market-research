...
from reporting.hk_key_variables import (
    _signal_snapshot,
    build_snapshot,
...
class HKKeyVariablesTests(unittest.TestCase):
    ...
    @mock.patch("reporting.hk_key_variables.fetch_china_releases")
    @mock.patch("reporting.hk_key_variables.fetch_market_proxies")
    @mock.patch("reporting.hk_key_variables.fetch_treasury")
    @mock.patch("reporting.hk_key_variables.fetch_hibor")
    @mock.patch("reporting.hk_key_variables.fetch_hk_liquidity")
    @mock.patch("reporting.hk_key_variables.fetch_southbound")
