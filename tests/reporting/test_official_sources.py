...
from reporting.official_sources.bls_calendar import BLSCalendarClient, MacroRelease
from reporting.official_sources.board_calendar import HKEXBoardCalendarClient
from reporting.official_sources.classifier import (
    classify_hkex_event,
    classify_hkex_events,
    classify_sec_event,
    classify_sec_events,
)
from reporting.official_sources.hkexnews import HKEXnewsClient, normalize_hk_symbol
from reporting.official_sources.event_context import EventContextBuilder, strongest_by_symbol
from reporting.official_sources.event_context_store import UnifiedEventStore
from reporting.official_sources.decision_ledger import DecisionLedger
from reporting.official_sources.decision_quality import _quality_gate, assess_decisions, parse_analysis_report
from reporting.official_sources.gates import evaluate_event_gate
from reporting.official_sources.macro_calibration import (
    apply_calibration,
    build_calibration,
    select_history,
)
from reporting.official_sources.macro_catalog import (
    classify_macro_event,
    macro_market_score,
    simple_macro_explanation,
    translate_macro_title,
)
from reporting.official_sources.macro_scenarios import analyze_release, scenario_probabilities
from reporting.official_sources.market_metrics import (
    calculate_history_metrics,
    normalize_volume_contract,
    to_longbridge_symbol,
)
from reporting.official_sources.models import OfficialFiling, OfficialKeyDate, UnifiedEvent
from reporting.official_sources.nasdaq_calendar import NasdaqMacroCalendarClient
from reporting.official_sources.sec_edgar import SECEdgarClient, normalize_us_symbol
from reporting.official_sources.storage import OfficialFilingStore
from reporting.official_sources.trading_cards import _first_price, _fmt, build_trade_card, expiry_after_sessions
from reporting.earnings_scenarios import build_earnings_scenario
    ...
    def test_sec_recent_filings_are_filtered_and_urls_are_official(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            client = SECEdgarClient(
                "hk-us-market-research-reporting tests@example.com",
...
""",
            ...
            items = parse_analysis_report(report, "us")
