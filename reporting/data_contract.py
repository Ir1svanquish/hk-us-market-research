"""Versioned, validated data contract for every stock in the reporting pool."""
...
from reporting.market_foundation import validate_effective_at, validate_trading_date
from reporting.earnings_scenarios import build_earnings_scenario
from reporting.opportunity_scoring import OpportunityResult, TECHNICAL_WEIGHTS, WEIGHTS
from reporting.research_report import ResearchStock


SCHEMA_VERSION = "reporting.stock-pool-snapshot.3"
SCORING_VERSION = "public-opportunity-reporting-structured-technical"
    ...
    *,
    ...
    return {
        ...
        "provenance": {
            ...
            "analysis_report": stock.data_sources,
        },
