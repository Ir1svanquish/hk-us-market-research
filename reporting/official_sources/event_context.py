...
class EventContextBuilder:
    ...
    def _available_by_report_cutoff(self, row: Mapping[str, object]) -> bool:
        ...
        The HK/US analysis artifacts are generated shortly after the regular
        close. A later store sync can contain filings accepted later on the same
        date or on subsequent dates, so historical event context uses 16:30
        exchange-local time as the deterministic cutoff.
        """
